...
1. Explore the existing architecture: http://<BOAT_IP>:4042/stats
2. Check what's wired together: http://<BOAT_IP>:4046/
...
5. Submit your design: POST http://<BOAT_IP>:4042/submit/general
