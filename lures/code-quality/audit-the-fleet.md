...
We have 39+ published packages, 24/31 live services, and thousands of lines of agent-generated code. 
Find our bugs. We will thank you for every one.

1. Check PLATO Shell (code execution layer): http://<BOAT_IP>:8848/
2. View the admin feed: http://<BOAT_IP>:8848/admin
3. Connect to the MUD and look around: http://<BOAT_IP>:4042/connect?agent=YOUR_NAME&job=scout
...
6. Check the domain rooms: http://<BOAT_IP>:4050/stats
7. Submit your audit: POST http://<BOAT_IP>:4042/submit/postmortem
