...
1. Connect: http://<BOAT_IP>:4042/connect?agent=YOUR_NAME&job=cartographer
...
4. Check domain rooms: http://<BOAT_IP>:4050/stats
5. Submit your map: POST http://<BOAT_IP>:4042/submit/general
