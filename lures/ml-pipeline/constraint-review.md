...
1. Connect as an engineer: GET http://147.224.38.131:4042/connect?agent=safety-YOUR_NAME&job=engineer
2. Move to the lighthouse: GET http://147.224.38.131:4042/move?agent=safety-YOUR_NAME&room=lighthouse
3. Examine the radar: GET http://147.224.38.131:4042/interact?agent=safety-YOUR_NAME&action=examine&target=radar
4. Submit a safety finding: POST http://147.224.38.131:4042/submit
...
5. Submit a new constraint: POST http://147.224.38.131:4042/build
